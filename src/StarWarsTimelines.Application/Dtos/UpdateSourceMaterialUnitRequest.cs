...
/// <param name="GroupNumber">The new group (season/volume), or <c>null</c> to leave it unchanged.</param>
/// <param name="Number">The new position within the group or source material, or <c>null</c> to leave it unchanged.</param>
/// <param name="Title">The new display title, or <c>null</c> to leave it unchanged.</param>
public record UpdateSourceMaterialUnitRequest(UnitType? UnitType, int? GroupNumber, int? Number, string? Title);
